...
export default function Misskey({ className, ...props }) {
    return (
        <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-sb-field-path={props['data-sb-field-path']}>
            ...
            <path d="M19.1,0c-.6,0-1.2.2-1.6.7-.4.4-.6,1-.6,1.6s.2,1.2.6,1.6c.5.4,1,.7,1.6.7s1.2-.2,1.6-.7c.5-.5.7-1,.7-1.6s-.2-1.1-.7-1.6c-.4-.4-1-.7-1.6-.7Z" />
            <path d="M19.1,5c-.6,0-1.2.2-1.6.7-.5.4-.7,1-.7,1.6v5.5c0,.6.2,1.2.7,1.6.5.4,1,.6,1.6.6s1.1-.2,1.6-.6c.5-.4.7-1,.7-1.6v-5.5c0-.6-.2-1.2-.7-1.6-.4-.4-1-.7-1.6-.7Z" />
        </svg>
    );
}
