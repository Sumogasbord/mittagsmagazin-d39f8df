...
いつも通り「出発駅」・「到着駅」・「乗車日」・「時刻」・「人数」を入力し、今回は小倉までですので操作は不要ですが、もし博多などまで行く場合は「小倉⇔博多間の新幹線や、九州外の発着を含める」に入っている☑をタッチしてチェックマークが入っていない状態にして「検索する」を押します。(☑のままだとQRチケット対応のきっぷが使えないため)
